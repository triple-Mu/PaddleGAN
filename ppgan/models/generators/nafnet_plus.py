...
class NAFBlock(nn.Layer):
    ...
    def __init__(self, c, DW_Expand=2, FFN_Expand=2, drop_out_rate=0.):
        ...
        self.conv1 = ConvBNSiLU(in_channels=c,
        ...
        self.conv4 = ConvBNSiLU(in_channels=c,
...
class NAFNetPlus(nn.Layer):
    ...
    def __init__(self,
        ...
        self.intro = ConvBNSiLU(in_channels=img_channel,
                                out_channels=width,
                                kernel_size=3,
                                padding=1,
                                stride=1,
        ...
        self.ending = ConvBNSiLU(in_channels=width,
        ...
        for num in enc_blk_nums:
            ...
            self.downs.append(ConvBNSiLU(chan, 2 * chan, 2, 2))
            chan = chan * 2
        ...
        for num in dec_blk_nums:
            self.ups.append(
                nn.Sequential(ConvBNSiLU(chan, chan * 2, 1, bias_attr=False),
                              nn.PixelShuffle(2)))
            chan = chan // 2
